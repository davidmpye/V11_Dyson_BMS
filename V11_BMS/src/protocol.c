...
static const prot_cfg_t prot_cfg[] = 
{
  ...
  {
    .msg_req_ptr      = msg_vac_type_v15,
    .msg_res_ptr      = NULL,
    .msg_req_cmp_size = sizeof(msg_vac_type_v15),
    .msg_res_size     = 0,
    .dest_state       = PROT_WAIT_FRAME, // for now, do nothing
#ifdef SERIAL_DEBUG
    .dump_bytes       = false,
    .debug_str        = "PROT:V15_DETECTED\r\n"
#endif
  },
  {
    .msg_req_ptr      = msg_vac_type_v11,
    .msg_res_ptr      = NULL,
    .msg_req_cmp_size = sizeof(msg_vac_type_v11),
    .msg_res_size     = 0,
    .dest_state       = PROT_WAIT_FRAME, // for now, do nothing
#ifdef SERIAL_DEBUG
    .dump_bytes       = false,
    .debug_str        = "PROT:V11_DETECTED\r\n"
#endif
  },
};
  ...
  switch(prot_state)
  {
    ...
    case PROT_TX_TRIGGER_RESP:
    {
      ...
      else
      {
        ...
        {
          serial_send((uint8_t*)msg_bms_trig_chrg_res, sizeof(msg_bms_trig_chrg_res));
        }
      }
